        ...
        <div id="part-1">
            ...
            <div class="row" id="part-2">
                ...
                <div class="col-xs-12 col-md-6 part-2-col">
                    ...
                    <button class="g-recaptcha" data-sitekey="6LcApzcUAAAAADn98yT0w7C_k4U0nN5F8H4OBzRO" data-callback="onSubmit" id="part-2-submit" type="submit" class="btn btn-default">Gönder</button>
                </div>
            </div>
